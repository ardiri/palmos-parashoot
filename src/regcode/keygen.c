 ...
 * All rights reserved.
 *
 * This file was generated as part of the "parashoot" program developed for 
...
main(int argc, char *argv[])
{
...

  {
    ...
    dhdr[0x40] = 'P';  dhdr[0x41] = 'C';  dhdr[0x42] = 'U';  dhdr[0x43] = 'T'; 
