----------------------------------------------------------------------------
 Parashoot: Championship Edition
----------------------------------------------------------------------------

  INSTALLATION:
  =============

  Parashoot is designed for the  Palm Computing Platform.  'parashoot.prc'
  should  be installed  into your handheld  device using the  instructions
  provided by the manufacturer.  The appropriate  display mode (black  and
  white, grayscale or color) will be used when the application is started.
  ...
  You  should install the  latest version of  Parashoot onto  your  device
  Parashoot can be installed and executed from flash memory! 

        http://www.ardiri.com/index.cfm?redir=palm&cat=parashoot
  ...
  Start  Parashoot  by tapping on the  application icon in the application
  ...
  Using the hard keys or the stylus, you must position your boat correctly
  and rescue  as many  parachuters as you can that have jumped and heading
  towards a lake with hungry sharks.  You may configure the  key and sound 
  volume in  the configuration  screen.  You get to this by selecting  the  
  menu item 'Config'  in  the 'Game' menu.  Consult your  handheld  device 
  manual for instructions of selecting a menu item. When a  game is active,  
  you may tap the speaker icon at the bottom left  of the screen to get to 
  the  configuration screen.  It is possible to pause the  current game in 
  progress by tapping the paw icon.

  REGISTRATION:
  =============
  
  Parashoot  is shareware,  the demonstration  version does  not allow the  
  player to generate high score codes or the ability to  save more than 50  
  parachuters. To access  these  features,  a device identification number
  is  required to generate a unique unlocking registration datafile.
  ...
  at the following web address:
   ...
   http://www.ardiri.com/index.cfm?redir=palm&cat=parashoot&subcat=survey
  ...
  Thankyou for downloading and playing Parashoot! 
